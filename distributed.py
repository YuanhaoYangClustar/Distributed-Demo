...
flags.DEFINE_string('ps_hosts', 'storage03.maas:22221', 'Comma-separated list of hostname:port pairs')
# 两个worker节点
flags.DEFINE_string('worker_hosts', 'cpu14.maas:22221,storage04.maas:22221',
